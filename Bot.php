...
$botToken = "1737673871:AAFCfGXza7VHeYpzdDXCaiK-bBfPkPIXne0
"; // Enter ur bot token
...
sendMessage($chatId, "<b>Hello monsieur.</b><b>To use me, type /all to know all commands.</b>", $message_id);
}

//////////=========[Cmds Command]=========/////////

elseif (strpos($message, "/all") === 0){
sendMessage($chatId, "<u>Check Bin:</u> <code>/bin</code> xxxxxx<u>Check Sk_live:</u> <code>/sk</code> sk_live_xxxxxxxx<u>Merchant CC Checker:</u> <code>/chk</code> xxxxxxxxxxxxxxxx|xx|xx|xxx%0A<u>Web Based CC Checker:</u> <code>/schk</code> xxxxxxxxxxxxxxxx|xx|xx|xxx%0A<u>Zee5 Checker:</u> <code>/zee5</code> Email:Pass%0A<u>Info:</u> <code>/info</code> To know ur info%0A%0A<b>Bot Made by: Team Zeltrax @ZeltraxRockz</b>", $message_id);
